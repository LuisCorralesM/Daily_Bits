...
const draggable = (img1,img2,img3,img4,img5)=>{
    document.addEventListener('click', e =>{
        if(e.target.matches('.img1-1 img')){
            ...
            <div class="img1 deshabilitar1">
                <img src="imagenes/icono-doctype.png" alt="logo angular" data-id="1">
            </div>
            `)
        ...
        if(e.target.matches('.img2-2 img')){
            ...
            divRespuestas.insertAdjacentHTML('beforeend', `
            <div class="img2 deshabilitar2" >
                <img src="imagenes/icono-body.png" alt="logo angular" data-id="2">
            </div>
            `)
        ...
        if(e.target.matches('.img3-3 img')){
            ...
            divRespuestas.insertAdjacentHTML('beforeend', `
            <div class="img3 deshabilitar3" >
                <img src="imagenes/icono-head.png" alt="logo angular" data-id="3">
            </div>
            `)
        ...
        if(e.target.matches('.img4-4 img')){
            ...
            divRespuestas.insertAdjacentHTML('beforeend', `
            <div class="img4 deshabilitar4" >
                <img src="imagenes/icono-html-a.png" alt="logo angular" data-id="4">
            </div>
            `)
        ...
        if(e.target.matches('.img5-5 img')){
            ...
            divRespuestas.insertAdjacentHTML('beforeend', `
            <div class="img5 deshabilitar5" >
                <img src="imagenes/icono-html-c.png" alt="logo angular" data-id="5">
            </div>
            `)
